/** @file DBUtil.h
 *  @brief DBUtil fasst saemtliche Funktionen fuer den Datenbankzugriff zusammen. In der Funktion connect sollten vor Inbetriebnahme die Datenbankinformationen angepasst werden.
 */
